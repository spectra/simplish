		<div id="sidebar" role="complementary">
			...
			<?php if (!dynamic_sidebar('widget-right-sidebar')): //If no widget sidebar, output default sidebar. ?>
				...
				<li id="categories"><?php the_widget('WP_Widget_Categories', 'count=24&dropdown=0&hierarchical=1'); ?></li>

      				<li id="archives"><?php the_widget('WP_Widget_Archives', 'count=24&dropdown=0'); ?></li>

				<?php wp_list_bookmarks(); ?>

				<li id="meta"><?php the_widget('WP_Widget_Meta') ?></li>
				<?php wp_meta(); ?>
			<?php endif; ?>
			</ul>
		</div><!-- #sidebar -->
