...
<abbr class="published posted_date" title="<?php the_time('Y-m-d\TH:i:sP') ?>"> <?php _e('on'); ?> <?php echo get_the_time(get_option('date_format'))  /* Use get_the_time() to avoid the_date() output bug in this context. */ ?></abbr>
				</div>
